...
def visualize():
    ...
    images_path = desktop+"/Filtered_dataset/scaled_images_bk"
    new_label_path = desktop+"/Filtered_dataset/fused_label"
    image_p =path.join(images_path,"0b60b0c918ad6879.jpg")
    image = cv2.imread(image_p)
    height = image.shape[0]
    width = image.shape[1]
    with open(path.join(new_label_path,"0b60b0c918ad6879.txt")) as fp:
        line = fp.readline()
        while line:
            x = line.split(" ")[1]
            y = line.split(" ")[2]
