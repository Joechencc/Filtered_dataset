...
def detect(image, depth, image_info, depth_info):
    ...
    file_path = "/home/chen1804/Desktop/Filtered_dataset/Lab_data/haha"
    #file_name = "image_"+str(count)+ "_"+ str(round(time,2)) + ".jpg"
    
    cur_time = time.time()
    new_sec = int(math.floor(cur_time))
    new_nsec = int((cur_time - math.floor(cur_time))*1e9)

    file_name = "image_"+ str(new_sec)+"_"+ str(new_nsec)+ ".jpg"
